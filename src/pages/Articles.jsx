    ...
    <div>
      <StyledSection pinkColor>
        <StyledCard primary>
          ...
          <p>
            The first cocktail ever made? Although opinions differ regarding
            what was the first cocktail ever made, there is no doubt that the
            Sazerac has made it into history being one of the first cocktails
            being recognized and a favorite until this day. This blend of
            whisky, absinthe, bitters and sugar surely made and impression.
          </p>
          <hr />
          <ul>
